...
var TooltipBar = /** @class */ (function (_super) {
    ...
    TooltipBar.prototype.init = function () {
        ...
        this.services.events.addEventListener("show-tooltip", function (e) {
            ...
            if ((e.detail.type === _interfaces_enums__WEBPACK_IMPORTED_MODULE_3__["TooltipTypes"].DATAPOINT && _tools__WEBPACK_IMPORTED_MODULE_1__["Tools"].getProperty(_this.model.getOptions(), "tooltip", "datapoint", "enabled"))
                ...
                var defaultTooltip = void 0;
                if (e.detail.multidata) {
                    // multi tooltip
                    defaultTooltip = _this.getMultilineTooltipHTML(e.detail.multidata);
                }
                else {
                    defaultTooltip = _this.getTooltipHTML(e.detail.hoveredElement.datum());
                }
                ...
                if (_tools__WEBPACK_IMPORTED_MODULE_1__["Tools"].getProperty(_this.model.getOptions(), "tooltip", "customHTML")) {
                    tooltipTextContainer.html(_this.model.getOptions().tooltip.customHTML(hoveredElement, defaultTooltip));
                }
                else {
                    // default tooltip
    ...
    TooltipBar.prototype.getTooltipHTML = function (data) {
        var valueFormatter = _tools__WEBPACK_IMPORTED_MODULE_1__["Tools"].getProperty(this.model.getOptions(), "tooltip", "valueFormatter");
        var formattedValue = valueFormatter ? valueFormatter(data.value) : data.value.toLocaleString("en");
    ...
    TooltipBar.prototype.getMultilineTooltipHTML = function (data) {
        ...
        return "<ul class='multi-tooltip'>" +
            points.map(function (datapoint) {
                var formattedValue = valueFormatter ? valueFormatter(datapoint.value) : datapoint.value.toLocaleString("en");
...
var Tooltip = /** @class */ (function (_super) {
        ...
        this.services.events.addEventListener("show-tooltip", function (e) {
            ...
            if ((e.detail.type === _interfaces__WEBPACK_IMPORTED_MODULE_6__["TooltipTypes"].DATAPOINT && _tools__WEBPACK_IMPORTED_MODULE_1__["Tools"].getProperty(_this.model.getOptions(), "tooltip", "datapoint", "enabled"))
                ...
                if (e.detail.multidata) {
                    ...
                    defaultTooltip = _this.getMultilineTooltipHTML(data);
                }
                else {
                    defaultTooltip = _this.getTooltipHTML(data, _interfaces__WEBPACK_IMPORTED_MODULE_6__["TooltipTypes"].DATAPOINT);
                }
                // if there is a provided tooltip HTML function call it
                if (_tools__WEBPACK_IMPORTED_MODULE_1__["Tools"].getProperty(_this.model.getOptions(), "tooltip", "customHTML")) {
                    tooltipTextContainer.html(_this.model.getOptions().tooltip.customHTML(data, defaultTooltip));
                }
                else {
                    // Use default tooltip
                    tooltipTextContainer.html(defaultTooltip);
    ...
    Tooltip.prototype.getTooltipHTML = function (data, type) {
        ...
        var valueFormatter = _tools__WEBPACK_IMPORTED_MODULE_1__["Tools"].getProperty(this.model.getOptions(), "tooltip", "valueFormatter");
        var formattedValue = valueFormatter ? valueFormatter(dataVal.value) : dataVal.value.toLocaleString("en");
    ...
    Tooltip.prototype.getMultilineTooltipHTML = function (data) {
        ...
        return "<ul class='multi-tooltip'>" +
            points.map(function (datapoint) {
                ...
                var valueFormatter = _tools__WEBPACK_IMPORTED_MODULE_1__["Tools"].getProperty(_this.model.getOptions(), "tooltip", "valueFormatter");
                var formattedValue = valueFormatter ? valueFormatter(datapointValue) : datapointValue.toLocaleString("en");
...
/* harmony import */ var _configuration__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./configuration */ "./src/configuration.ts");
/* harmony reexport (module object) */ __webpack_require__.d(__webpack_exports__, "configurations", function() { return _configuration__WEBPACK_IMPORTED_MODULE_2__; });
/* harmony import */ var _interfaces__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./interfaces */ "./src/interfaces/index.ts");
/* harmony reexport (module object) */ __webpack_require__.d(__webpack_exports__, "interfaces", function() { return _interfaces__WEBPACK_IMPORTED_MODULE_3__; });
